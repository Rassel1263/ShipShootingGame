...
public:
	...
	Effect(std::wstring eftName, D3DXVECTOR2 pos, D3DXVECTOR2 scale, float aniTime, float visibleTime, bool bCamera = false, float rotate = 0, std::function<void()> func = 0);
